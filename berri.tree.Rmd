...
#      list(id = 'Board'),
     ...
     list(id = 'CPs', title = 'CPs', name = 'Clinical Psychologists', color = '#007ad0', #image = ,
      ...
      list(id = 'CPO', title = 'Job Role', name = 'Emma',
           image = 'https://github.com/chris-gaskell/BERRI.orgchart/blob/main/images/Scott%20Milsom%20-%20Brick%20Background%20.jpg?raw=true',
           column = 1),
      list(id = 'CSO', title = 'CSO', name = 'Ben',
           image = 'https://github.com/chris-gaskell/BERRI.orgchart/blob/main/images/IMG_7457.jpg?raw=true',
           column = 1, layout = 'hanging'),
      list(id = 'CMO', title = 'CMO', name = 'Vidar Brekke',
           image = 'https://github.com/chris-gaskell/BERRI.orgchart/blob/main/images/IMG_7453.jpg?raw=true',
           column = 1, layout = 'hanging'),
