...
#      list(id = 'Board'),
     ...
     list(id = 'CPs', title = 'CPs', name = 'Clinical Psychologists', color = '#007ad0', #image = ,
      ...
      list(id = 'CPO', title = 'Job Role', name = 'Emma', image = 'https://github.com/chris-gaskell/BERRI.orgchart/blob/main/images/IMG_7445.jpg?raw=true', column = 1),
      list(id = 'CSO', title = 'CSO', name = 'Anita Nesse', image = 'https://wp-assets.highcharts.com/www-highcharts-com/blog/wp-content/uploads/2018/11/12132313/Anita.jpg', column = 1, layout = 'hanging'),
      list(id = 'CMO', title = 'CMO', name = 'Vidar Brekke', image = 'https://wp-assets.highcharts.com/www-highcharts-com/blog/wp-content/uploads/2018/11/13105551/Vidar.jpg', column = 1, layout = 'hanging'),
      list(id = 'Product', name = 'Product developers'),
      list(id = 'Chris', name = 'Chris', column = 2),
