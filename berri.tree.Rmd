...
# Ben
  list(id = 'Ben', title = 'Head of Growth and Success', name = 'Ben Paul',
       ...
       column = 1, layout = 'hanging'),
# Richard & Ned
  list(id = 'R+D', name = 'Richard & Dan (Ned)',
       #image = 'https://github.com/chris-gaskell/BERRI.orgchart/blob/main/images/Ben.jpg?raw=true',
...
# Chris 
  list(id = 'Chris', title = 'Clinical Psychologist', name = 'Chris Gaskell',
       image = 'https://www.chris-gaskell.com/me.jpg', column = 3),
# Lucky
   list(id = 'Lucky', title = 'Clinical Psychologist', name = 'Lucky',
         image = 'https://www.chris-gaskell.com/me.jpg', column = 3),
# Liam
   list(id = 'Liam', title = 'Clinical Psychologist', name = 'Liam',
         image = 'https://www.chris-gaskell.com/me.jpg', column = 3),
# Jasmine
  list(id = 'Jasmine', name = 'Jasmine', title = "N/A"
       #image = 
       ),
# Richard 
  list(id = 'Richard', name = 'Richard', title = "N/A"
       #image =
       ),
# Scott 
  list(id = 'Scott', name = 'Scott', title = "N/A",
        image = 'https://www.chris-gaskell.com/me.jpg'),
# Amy
  list(id = 'Amy', name = 'Amy', title = "N/A",
       image = 'https://www.chris-gaskell.com/me.jpg'),
# Beth
  list(id = 'Beth', name = 'Beth', title = "N/A",
       image = 'https://www.chris-gaskell.com/me.jpg', column = 6),
# Shannon
  list(id = 'Shannon', name = 'Shannon', title = "N/A",
       image = 'https://www.chris-gaskell.com/me.jpg', column = 6),
# Zara
  list(id = 'Zara', name = 'Zara', title = "N/A",
       image = 'https://www.chris-gaskell.com/me.jpg', column = 5),
# Sophie
  list(id = 'Sophie', name = 'Sophie', title = "N/A",
       image = 'https://www.chris-gaskell.com/me.jpg', column = 6)
     ),
